...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>K
<!--
Author: W3layouts
            ...
            <div class="details-1">
                <div class="col-md-10 dropdown-buttons">
                    ...
                    <div class="col-md-3 dropdown-button">
                        <div class="book_date">
                            <form>
                                <input class="date" id="datepicker" type="text" value="Check In"
                                       onfocus="this.value = '';"
                    ...
                    <div class="col-md-3 dropdown-button">
                        <div class="book_date">
                            <form>
                                <input class="date1" id="datepicker1" type="text" value="Check Out"
                                       onfocus="this.value = '';"
...
<div class="hod">
    <div class="container">
        <div class="col-md-6 hod-left">
            <img src="${pageContext.request.contextPath}/resources/images/14.jpg" class="img-responsive" alt="">
        </div>
        <div class="col-md-6 hod-right">
            <h2>Publishing packages and web page</h2>
            <p>The point of using as opposed to using 'Content here, content here', making it look like readable
                English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default
                model text, and a search for 'lorem ipsum' </p>
...
<div class="tels">
    <div class="container">
        ...
        <div class="col-md-4 tels-left">
            ...
            <img src="${pageContext.request.contextPath}/resources/images/9.jpg" class="img-responsive" alt="">
            <p>Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content
                here, content here',</p>
            <a class="hvr-shutter-in-horizontal" href="details.html">Book Now</a>
        </div>
    ...
    <div class="container">
        ...
        <div class="col-md-4 quick-left">
            ...
            <form>
                ...
                <textarea placeholder="" onfocus="this.value='';"
